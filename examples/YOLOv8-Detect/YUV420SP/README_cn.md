...
### RDK X5 & RDK X5 Module
目标检测 Detection (COCO)
| 模型 | 尺寸(像素) | 类别数 | 参数量 | BPU任务延迟/BPU吞吐量(线程) |  后处理时间<br/> |
|---------|---------|---------|----------|--------------------|--------------------|
| YOLOv8n | 640×640 | 80 | 3.2 M  | 5.6  ms / 178.0 FPS (1 thread ) <br/> 7.5 ms / 263.6 FPS (2 threads) | 5 ms |
| YOLOv8s | 640×640 | 80 | 11.2 M | 12.4 ms / 80.2  FPS (1 thread ) <br/> 21 ms / 94.9 FPS (2 threads) | 5 ms |
| YOLOv8m | 640×640 | 80 | 25.9 M | 29.9 ms / 33.4  FPS (1 thread ) <br/> 55.9 ms / 35.7 FPS (2 threads) | 5 ms |
| YOLOv8l | 640×640 | 80 | 43.7 M | 57.6 ms / 17.3  FPS (1 thread ) <br/> 111.1 ms / 17.9 FPS (2 threads) | 5 ms |
| YOLOv8x | 640×640 | 80 | 68.2 M | 90.0 ms / 11.0  FPS (1 thread ) <br/> 177.5 ms / 11.2 FPS (2 threads) | 5 ms |
